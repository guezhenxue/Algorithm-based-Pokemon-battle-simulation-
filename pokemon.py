...
def get_all_pokemon_types() -> ArrayR:
    """
    Returns an array of all Pokemon types.

    Preconditions:
        The array must contains elements 

    Postconditions:
        The array should not be modified.

    Returns:
        all_pokemon (ArrayR): Array with classes of pokemons.
    
    Complexity:
        Best case O(1), when there is 1 class in the module
        Worst case O(N), where N is the number of classes in the module.
    """
